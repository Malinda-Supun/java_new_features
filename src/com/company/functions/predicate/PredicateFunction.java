package com.company.functions.predicate;
...
public class PredicateFunction {
	...
	public static void main(String[] args) {
		Predicate<Employee> bonsusPredict = emp -> emp.getRatings()>10? true:false;

		System.out.println(bonsusPredict.test(new Employee("1")));
